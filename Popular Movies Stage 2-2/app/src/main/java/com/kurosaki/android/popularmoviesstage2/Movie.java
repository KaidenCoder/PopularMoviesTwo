...

{
    ...
    Movie(Bundle bundle)
    {
        this(bundle.getLong(KEY_ID),
                ...
                bundle.getDouble(KEY_VOTE_COUNT ),
                bundle.getLong(KEY_VOTE_AVERAGE),
    ...
    Bundle toBundle()
    {
        ...
        bundle.putDouble(KEY_VOTE_COUNT , vote_average);
        bundle.putLong(KEY_VOTE_AVERAGE, vote_count);
    ...
    static Movie getMovieFromJson(JSONObject jsonObject) throws JSONException
    {
        return new Movie(jsonObject.getLong(KEY_ID),
                ...
                jsonObject.getDouble(KEY_VOTE_COUNT ),
                jsonObject.getLong(KEY_VOTE_AVERAGE),
    ...
    Uri getPosterUri(String size)
    {
        ...
        final String BASE_URL = POSTER_IMG_URL;
    ...
    //removing a movie from bookmarks
